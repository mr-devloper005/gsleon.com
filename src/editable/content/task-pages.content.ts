...
export const taskPageVoices = {
  ...
  profile: {
    eyebrow: 'Direct identity',
    headline: 'Identity pages with useful context and owned links.',
    description: 'Identity pages remain available by direct URL while staying out of the public discovery surface.',
